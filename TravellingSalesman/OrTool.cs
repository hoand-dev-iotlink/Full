...
namespace FullMin.TravellingSalesman
{
    public class OrTool
    {
        ...
        private long[,] ComputeEuclideanDistanceMatrix(in int[,] locations)
        {
        ...
        public void init()
        {
            ...
            RoutingIndexManager manager =
                new RoutingIndexManager(Locations.GetLength(0), VehicleNumber, Depot);

            // Create Routing Model.
            RoutingModel routing = new RoutingModel(manager);

            // Define cost of each arc.
            long[,] distanceMatrix = ComputeEuclideanDistanceMatrix(Locations);
